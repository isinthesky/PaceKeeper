...
class CategoryService(QObject):
    ...
    # 시그널 정의
    categoryCreated = pyqtSignal(Category)
    categoryUpdated = pyqtSignal(Category)
    ...
    def create_category(self, name: str, description: str = "", color: str = "#4a86e8") -> Category:
        """
        새 카테고리 생성
        ...
        # 새 카테고리 생성
        category = Category(name=clean_name, description=description, color=color)
