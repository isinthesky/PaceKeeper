...
class LogRepository:
    ...
    def create(self, log_entry: LogEntity) -> LogEntity:
        ...
        log_id = self.db_manager.insert(
            query, 
            (log_entry.message, log_entry.tags, log_entry.start_date, log_entry.end_date, log_entry.state)
        )
        log_entry.id = log_id
    ...
    def update(self, log_entry: LogEntity) -> bool:
        ...
        self.db_manager.execute_query(
            query, 
            (log_entry.message, log_entry.tags, log_entry.start_date, 
             log_entry.end_date, log_entry.state, log_entry.id)
        )
