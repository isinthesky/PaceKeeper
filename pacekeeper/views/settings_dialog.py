...
from PyQt5.QtWidgets import (
    ...
    QSpinBox, QComboBox, QGroupBox, QFormLayout, QCheckBox,
    QColorDialog, QWidget, QTabWidget, QSlider
)
...
from pacekeeper.consts.settings import (
    SET_STUDY_TIME, SET_SHORT_BREAK_TIME, SET_LONG_BREAK_TIME, 
    SET_POMODORO_CYCLES, SET_SOUND_ENABLE, SET_TTS_ENABLE,
    SET_ALARM_VOLUME, SET_BREAK_COLOR, SET_LANGUAGE, 
    AVAILABLE_LANG_LABELS, AVAILABLE_LANGS
)
